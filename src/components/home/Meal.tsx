...
export default function Meal() {
  return (
    <div className="border-2 border-green-600 h-full w-[28rem] p-4 bg-white rounded-md ">
      <Tabs defaultValue="add-meal" className="w-full flex flex-col  h-fit ">
        <TabsList className="w-full h-[3rem] mb-5">
          <TabsTrigger value="add-meal">Add Mean</TabsTrigger>
          <TabsTrigger value="add-exercise">Add Exercise</TabsTrigger>
        </TabsList>
        <TabsContent value="add-meal" className="w-full">
          <div className="w-full border-2  flex justify-between items-center p-4 mb-2 rounded-sm bg-gray-50">
            <div>
